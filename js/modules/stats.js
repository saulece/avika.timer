...
Avika.stats = {
    ...
    // Calcular tiempo de entrega para una orden
    calculateDeliveryTime: function(order) {
        ...
        // Validar fechas
        if (!Avika.utils.isValidDate(departureTime) || !Avika.utils.isValidDate(arrivalTime)) {
            return 'No disponible';
        }
    ...
    // Calcular tiempo total para una orden
    calculateTotalTime: function(order) {
        if (!order.startTime || !order.completionTime) {
            return 'No disponible';
        }
        ...
        // Validar fechas
        if (!Avika.utils.isValidDate(startTime) || !Avika.utils.isValidDate(completionTime)) {
            return 'No disponible';
        }
